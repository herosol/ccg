<?= getBredcrum(ADMIN, array('#' => 'Qualification Page')); ?>
<?= showMsg(); ?>
<div class="row margin-bottom-10">
    <div class="col-md-6">
        <h2 class="no-margin"><i class="entypo-window"></i> Update <strong>Qualification Page</strong></h2>
    </div>
...
<div>
    ...
    <div class="panel-body">
        <form role="form"  method="post" class="form-horizontal form-groups-bordered validate" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <h3> <?= ucfirst(trim($row['bq_heading'])); ?> Section</h3>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <textarea name="bq_heading" rows="2" class="form-control" ><?= $row['bq_heading'] ?></textarea>
                            </div>
                            <div class="col-md-12">
                                <label for="bq_detail" class="control-label"> Short Detail <span class="symbol required">*</span></label>
                                <textarea name="bq_detail" rows="2" class="form-control ckeditor" required=""><?= $row['bq_detail'] ?></textarea>
                            </div>
                            <div class="col-md-6">
                                <label for="bq_button_text" class="control-label"> Button Text <span class="symbol required">*</span></label>
                                <input type="text" name="bq_button_text" id="bq_button_text" value="<?= $row['bq_button_text'] ?>" class="form-control" required>
                            </div>
                            <div class="col-md-6">
                                <label for="bq_button_link" class="control-label"> Button Link <span class="symbol required">*</span></label>
                                <select name="bq_button_link" id="bq_button_link" class="form-control" required>
                                    <option value=''>-- Select --</option>
                                    <?php $pages = get_pages();
                                    foreach($pages as $page){?>
                                        <option value="<?=$page?>" <?=($row['bq_button_link']==$page)?'selected':'' ?>> <?=$page?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
...
<form role="form" action="<?= base_url().ADMIN ?>/sitecontent/save_affiliate"  method="post" class="form-horizontal form-groups-bordered validate" novalidate="novalidate" enctype="multipart/form-data">
            <h3> <?= !empty($id) ? 'Edit' : 'Add'?> Property Qualification Card</h3>
            <div class="form-group">
                <div class="col-md-3">
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-primary" role="menu">
                                                <li><a href="<?= site_url(ADMIN); ?>/sitecontent/qualification/<?= $row->id; ?>">Edit</a></li>
                                                <?php if(access(10)):?>
                                                    <li><a href="<?= site_url(ADMIN); ?>/sitecontent/delete_qualification/<?= $row->id; ?>" onclick="return confirm('Are you sure?');">Delete</a></li>
                                                <?php endif?>
                                    </ul>
                                </div>  
                            </td>
