...
<head>
    <title>Terms & Conditions — CCG</title>
    ...
    <section id="sBanner" style="background-image: url('images/3q.jpg');">
        ...
        <section id="terms">
            <div class="contain">
                ...
                <h1 class="heading text-center">Commercial Mortgage Terms</h1>
                    ...
                    <h3>A. 30/360</h3>
                    <p>An interest rate accrual method in which the interest calculation assumes that all 12 months of a calendar year have 30 days and uses a 360-day year. An Actual/360 interest calculation charges interest for all 365 calendar days using a 360-day year. Therefore, borrowers pay 5 days less interest than under Actual/360.</p>

                    <h3>B. Acceleration Clause</h3>
                    <p>The acceleration clause is the section in a mortgage that says if the borrower sells the property or places a second mortgage / mezzanine loan on the property that the bank can immediately demand to be paid in full.</p>
                    
                    <h3>C. ACH</h3>
                    <p>Stands for Automated Clearing House. Refers to Auto-Pay for a commercial mortgage for loan servicing</p>

                    <h3>D. Actual 360</h3>
                    <p>An interest rate accrual method in which interest calculation charges interest for all 365 calendar days using a 360-day year. A 30/360 interest calculation assumes that all 12 months of a calendar year have 30 days and uses a 360-day year. Therefore, borrowers pay 5 days more interest than under 30/360.</p>

                    <h3>E. Actual 365</h3>
                    <p>An interest accrual method in which the annual interest will be divided by a 365 day year, and the interest for each interest period will be the interest for the actual number of days in that period. The number of days in the year for periodic calculation is usually one of three choices: 1) actual days in the year (365 or 366 for leap years), 2) always 365 days, or 3) always 360 days (based on 12 x 30-day months). Each interest basis reflects a choice for computing the number of days in the interest period and the number of days in the year in which interest is paid.</p>

                    <h3>F. Actual/Actual</h3>
                    <p>An interest accrual method in which the annual interest will be divided by a 365-day year, and the interest for each interest period will be the interest for the actual number of days in that period.</p>

                    <h3>G. APR (Annual Percentage Rate)</h3>
                    <p>The effective interest rate a loan would have if one accounted for costs associated with securing the loan, such as closing costs and points. It represents the annual cost of a loan and is thus a more reliable indicator for comparing different mortgage options.</p>
