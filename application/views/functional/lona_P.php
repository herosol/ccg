...
<body id="home-page">
        ...
        <section id="sBanner" style="background-image: url('images/3q.jpg');">
            <div class="contain">
                <div class="content">
                    ...
                    <h2 class="regular">Commercial Loan Process</h2>
                </div>
            </div>
        </section>
        <!-- sBanner -->
        ...
        <section class="business">
            <div class="contain">
                <div class="flexRow flex">
                    ...
                    <div class="col col2">
                        <div class="content">
                            <h1 class="heading">Identify Mortgage Brokerage</h1>
	...
	<div class="contain">
		<div class="flex">
			<div class="colL">
				<div class="inner">
					<h1 class="heading">AKnow Our Loan Process</h1>
					<p>Shall under In yielding saying given dominion don't of two god which said. Creature dominion was the good creepeth to give bring doesn't first shall two signs is a gathered set of people.</p>
				</div>
				<div class="flex">
					<div class="col">
						<div class="innerCol">
